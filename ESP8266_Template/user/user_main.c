...
void user_init(void)
{
	...
	lcd_init ();			// Initialize TFT (also takes care of HSPI)
	lcd_set_rotation (0);	// 0-2 : portrait. 1-3 : landscape

	lcd_fill_screen (0x0000);		// make the screen black (0xFFFF for white)
